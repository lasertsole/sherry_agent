...
def _build_worker_prompt() -> str:
    ...
    skill_note: str = f"""
    Additional notes:
    1. Use skill_list to see available skills. Use skill_view("skill_name") to read a skill's SKILL.md content.
    ...
    try:
        ...
        async def execute_task() -> str:
            ...
            from agent.tools import (build_read_file_tool, build_write_file_tool, build_patch_file_tool,
                                     ...
                                     build_skill_list_tool, build_skill_view_tool)
