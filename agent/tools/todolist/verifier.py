"""Sisyphus completion verifier: record evidence for a finished checkbox.

This module implements the evidence-recording half of the 5-gate completion
contract (see skills/builtin/core/ulw-execute/SKILL.md). Gates 2 (automated commands) and 3
