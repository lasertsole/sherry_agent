"""Unit tests for pub/types/bus.py — InboundMessage and OutboundMessage dataclasses."""
...
class TestInboundMessage:
    ...
    def test_basic_construction(self):
        msg = InboundMessage(
            channel="telegram", sender_id="user123", chat_id="chat456", content="Hello!"
        )
    ...
    def test_unique_id_with_session_id(self):
        msg = InboundMessage(
            channel="telegram", sender_id="u1", chat_id="c1", content="hi", session_id="session-abc"
        )
...
class TestOutboundMessage:
    ...
    def test_basic_construction(self):
        msg = OutboundMessage(channel="telegram", chat_id="chat456", content="Reply!")
        assert msg.channel == "telegram"
        assert msg.chat_id == "chat456"
    ...
    def test_reply_to_set(self):
        msg = OutboundMessage(channel="telegram", chat_id="c1", content="hi", reply_to="msg-123")
    ...
    def test_media_list(self):
        msg = OutboundMessage(
            channel="telegram", chat_id="c1", content="hi", media=["http://example.com/img.png"]
        )
        assert len(msg.media) == 1
