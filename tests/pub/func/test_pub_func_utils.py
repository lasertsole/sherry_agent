"""Unit tests for pure-logic helpers in pub/func/.

Covers:
- pub/func/cjk.py                       (contains_cjk, is_cjk_codepoint, count_cjk)
- pub/func/string_to_int.py             (string_to_int, string_to_unique_int, rand_str_to_int)
- pub/func/generate_tsid.py             (generate_tsid)
- pub/func/process_sse_data.py          (process_sse_data)
- pub/func/extract_text_from_content.py (extract_text_from_content)
"""

import pytest
from types import SimpleNamespace

from pub.func.cjk import contains_cjk, is_cjk_codepoint, count_cjk
from pub.func.string_to_int import string_to_int, string_to_unique_int, rand_str_to_int
from pub.func.generate_tsid import generate_tsid
from pub.func.process_sse_data import process_sse_data
from pub.func.extract_text_from_content import extract_text_from_content
