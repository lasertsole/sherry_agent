...
SPOT_DEFAULTS = [
    ...
    (TOKEN_ESTIMATION, "tokens_per_image_block", 85),
    (TOKEN_ESTIMATION, "tokens_per_audio_block", 256),
    (TOKEN_ESTIMATION, "tokens_per_video_block", 1024),
    (TOKEN_ESTIMATION, "tokens_per_unknown_block", 85),
    ...
    (MEMORY_TOOL, "facts_char_limit", 1_375),
    ...
    (LLM_CLIENT_DEFAULTS, "reasoner_timeout", 120),
    (LLM_CLIENT_DEFAULTS, "local_n_gpu_layers", -1),
    (LLM_CLIENT_DEFAULTS, "ittt_remote_temperature", 0.8),
    (LLM_CLIENT_DEFAULTS, "ittt_remote_timeout", 120),
    (LLM_CLIENT_DEFAULTS, "vttt_remote_timeout", 120),
