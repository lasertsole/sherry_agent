...
- **双记忆架构**：短期对话记忆 [MesMemory](context_engine/README.zh.md) + 长期经验知识图谱 [XpGraph](agent/tools/pub_base/xp_graph/README.zh.md)
...
- ▶️ _详见 [Context Engine 文档](context_engine/README.zh.md) 和 [XpGraph 文档](agent/tools/pub_base/xp_graph/README.zh.md)_
...
| 子模块 | 说明 | 文档 |
|--------|------|------|
| **Context Engine** | 短期会话消息记忆（MesMemory） | [中文](context_engine/README.zh.md) · [英文](context_engine/README.md) |
| **XpGraph** | 长期经验知识图谱 | [中文](agent/tools/pub_base/xp_graph/README.zh.md) · [英文](agent/tools/pub_base/xp_graph/README.md) |
