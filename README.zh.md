...
- **下一代客户端** ([client_future](client_future/README.zh.md))：基于 Nuxt.js + Tauri 的桌面/移动客户端，正在开发中
...
| **前端 UI** | Streamlit, Nuxt.js + Tauri (下一代客户端) |
...
├── client_future/          # 下一代客户端 (Nuxt.js + Tauri)
│   ├── app/                # Vue 3 前端
│   ├── src-tauri/          # Tauri 桌面壳
...
| **Next-gen Client** | Nuxt.js + Tauri 桌面/移动客户端 | [中文](client_future/README.zh.md) · [EN](client_future/README.md) |
