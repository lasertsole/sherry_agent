...
if TYPE_CHECKING:
    from graph_rag.vendored_lightrag.base import BaseKVStorage, BaseVectorStorage, QueryParam
...
def write_json(json_obj, file_name):
    ...
    """
    from graph_rag.vendored_lightrag.file_atomic import atomic_write
...
def check_storage_env_vars(storage_name: str) -> None:
    ...
    """
    from graph_rag.vendored_lightrag.kg import STORAGE_ENV_REQUIREMENTS
