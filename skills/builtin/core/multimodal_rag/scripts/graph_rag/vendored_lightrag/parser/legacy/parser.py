...
from graph_rag.vendored_lightrag.constants import FULL_DOCS_FORMAT_RAW, PARSER_ENGINE_LEGACY
...
class LegacyParser(BaseParser):
    ...
    async def parse(self, ctx: ParseContext) -> ParseResult:
        from graph_rag.vendored_lightrag.parser.legacy.extractors import (
            LegacyExtractionError,
            extract_text,
        )
        from graph_rag.vendored_lightrag.parser.registry import suffix_capabilities
