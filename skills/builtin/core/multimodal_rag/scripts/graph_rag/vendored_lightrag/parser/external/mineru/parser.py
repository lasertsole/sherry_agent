...
from graph_rag.vendored_lightrag.constants import MINERU_RAW_DIR_SUFFIX, PARSER_ENGINE_MINERU
...
class MinerUParser(ExternalParserBase):
    ...
    def is_bundle_valid(self, raw_dir: Path, source_path: Path) -> bool:
        from graph_rag.vendored_lightrag.parser.external.mineru import is_bundle_valid
