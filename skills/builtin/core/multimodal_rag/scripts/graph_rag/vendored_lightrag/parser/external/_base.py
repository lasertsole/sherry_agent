...
from graph_rag.vendored_lightrag.constants import FULL_DOCS_FORMAT_LIGHTRAG
from graph_rag.vendored_lightrag.parser.base import BaseParser, ParseContext, ParseResult
...
class ExternalParserBase(BaseParser):
    ...
    async def parse(self, ctx: ParseContext) -> ParseResult:
        ...
        from graph_rag.vendored_lightrag.sidecar import write_sidecar
