...
from graph_rag.vendored_lightrag.constants import PARSER_ENGINE_NATIVE
from graph_rag.vendored_lightrag.parser.native_base import NativeParserBase
...
class NativeDocxParser(NativeParserBase):
    ...
    def extract(
        ...
        from graph_rag.vendored_lightrag.parser.docx.drawing_image_extractor import (
            DrawingExtractionContext,
            load_relationships,
        )
        from graph_rag.vendored_lightrag.parser.docx.parse_document import extract_docx_blocks
