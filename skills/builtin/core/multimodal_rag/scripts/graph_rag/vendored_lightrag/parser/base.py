...
if TYPE_CHECKING:
    from graph_rag.vendored_lightrag.sidecar.ir import IRDoc  # noqa: F401
...
class ParseContext:
    ...
    def source_path(self, parser_engine: str) -> Path:
        ...
        from graph_rag.vendored_lightrag.pipeline import (
    ...
    async def archive_source(self, source_path: str) -> str | None:
        ...
        """
        import graph_rag.vendored_lightrag.pipeline as _pipeline
