...
from graph_rag.vendored_lightrag.parser.external._common import compute_size_and_hash, env_bool
from graph_rag.vendored_lightrag.parser.external._manifest import load_manifest
from graph_rag.vendored_lightrag.parser.external.docling import MANIFEST_ENGINE
...
def is_bundle_valid(raw_dir: Path, source_file: Path) -> bool:
    ...
    if manifest.options_signature:
        from graph_rag.vendored_lightrag.parser.external.docling.client import FIXED_CONSTANTS
