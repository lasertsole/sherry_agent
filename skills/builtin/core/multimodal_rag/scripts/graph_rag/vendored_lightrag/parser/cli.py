...
def _build_parser() -> argparse.ArgumentParser:
    ...
    from graph_rag.vendored_lightrag.parser.registry import supported_parser_engines
...
async def _run(args: argparse.Namespace) -> int:
    ...
    from graph_rag.vendored_lightrag.constants import FULL_DOCS_FORMAT_PENDING_PARSE
    ...
    from graph_rag.vendored_lightrag.parser.registry import get_parser, suffix_capabilities
    from graph_rag.vendored_lightrag.parser.debug import build_debug_rag
    from graph_rag.vendored_lightrag.parser.docx.parse_document import DocxContentError
    from graph_rag.vendored_lightrag.utils import compute_mdhash_id
    import graph_rag.vendored_lightrag.pipeline as pipeline_mod
    import graph_rag.vendored_lightrag.utils_pipeline as utils_pipeline_mod
...
def main(argv: list[str] | None = None) -> int:
    ...
    from graph_rag.vendored_lightrag.parser.plugins import load_third_party_parsers
