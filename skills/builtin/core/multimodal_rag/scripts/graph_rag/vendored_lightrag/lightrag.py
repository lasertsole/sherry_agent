...
from graph_rag.vendored_lightrag.kg import (
    verify_storage_implementation,
)


from graph_rag.vendored_lightrag.kg.shared_storage import (
    get_namespace_data,
...
from graph_rag.vendored_lightrag.base import (
    BaseGraphStorage,
    BaseKVStorage,
    BaseVectorStorage,
    DocProcessingStatus,
...
from graph_rag.vendored_lightrag.namespace import NameSpace
from graph_rag.vendored_lightrag.chunker import chunking_by_token_size
from graph_rag.vendored_lightrag.operate import (
    extract_entities,
    kg_query,
    naive_query,
    rebuild_knowledge_from_chunks,
)
from graph_rag.vendored_lightrag.utils_pipeline import normalize_document_file_path
from graph_rag.vendored_lightrag.constants import GRAPH_FIELD_SEP
from graph_rag.vendored_lightrag.exceptions import IndexFlushError
...
from graph_rag.vendored_lightrag.types import KnowledgeGraph
from dotenv import load_dotenv
from graph_rag.vendored_lightrag.pipeline import _PipelineMixin
from graph_rag.vendored_lightrag.kg.factory import get_storage_class
from graph_rag.vendored_lightrag.addon_params import (
    ObservableAddonParams,
    normalize_addon_params,
)
from graph_rag.vendored_lightrag.llm_roles import (
    ROLE_NAMES,
    ROLES,
    RoleLLMConfig,
...
from graph_rag.vendored_lightrag.storage_migrations import _StorageMigrationMixin
...
class LightRAG(_RoleLLMMixin, _StorageMigrationMixin, _PipelineMixin):
    ...
    kv_storage: str = field(default="SNKVKVStorage")
    """Storage backend for key-value data."""

    vector_storage: str = field(default="SNKVVectorStorage")
    """Storage backend for vector embeddings."""

    graph_storage: str = field(default="SNKVGraphStorage")
    """Storage backend for knowledge graphs."""

    doc_status_storage: str = field(default="SNKVDocStatusStorage")
    ...
    **Signature** — preserved unchanged from earlier LightRAG releases
    ...
    async def ainsert(
        ...
        from graph_rag.vendored_lightrag.parser.routing import resolve_chunk_options
    ...
    async def adelete_by_entity(self, entity_name: str) -> DeletionResult:
        ...
        Returns:
            DeletionResult: An object containing the outcome of the deletion process.
        """
        from graph_rag.vendored_lightrag.utils_graph import adelete_by_entity
    ...
    async def adelete_by_relation(self, source_entity: str, target_entity: str) -> DeletionResult:
        ...
        Returns:
            DeletionResult: An object containing the outcome of the deletion process.
        """
        from graph_rag.vendored_lightrag.utils_graph import adelete_by_relation
    ...
    async def get_entity_info(
        ...
        from graph_rag.vendored_lightrag.utils_graph import get_entity_info
    ...
    async def get_relation_info(
        ...
        from graph_rag.vendored_lightrag.utils_graph import get_relation_info
    ...
    async def aedit_entity(
        ...
        """
        from graph_rag.vendored_lightrag.utils_graph import aedit_entity
    ...
    async def aedit_relation(
        ...
        """
        from graph_rag.vendored_lightrag.utils_graph import aedit_relation
    ...
    async def acreate_entity(self, entity_name: str, entity_data: dict[str, Any]) -> dict[str, Any]:
        ...
        """
        from graph_rag.vendored_lightrag.utils_graph import acreate_entity
    ...
    async def acreate_relation(
        ...
        """
        from graph_rag.vendored_lightrag.utils_graph import acreate_relation
    ...
    async def amerge_entities(
        ...
        """
        from graph_rag.vendored_lightrag.utils_graph import amerge_entities
    ...
    async def aexport_data(
        ...
        """
        from graph_rag.vendored_lightrag.utils import aexport_data as utils_aexport_data
