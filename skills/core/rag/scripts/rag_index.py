...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("用法: python rag_index.py <input_folder_path> <classify_folder>")
        print("示例: python rag_index.py /path/to/documents my_docs")
        sys.exit(1)

    _input_folder_path: str = sys.argv[1]
    _classify_folder: str = sys.argv[2]
