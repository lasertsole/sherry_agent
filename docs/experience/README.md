...
- the agent has been idle for at least `curator.min_idle_hours`, default 2 (`context_engine/curator/orchestrator.py:108-115`). Every user turn resets that idle timer (`server/service/messages.py:190`).
