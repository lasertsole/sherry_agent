...
- **Integration** (`pnpm test:integration`): colocated `app/**/__tests__/*.integration.test.ts` — mounts real `.vue` SFCs (ChatBox, HistoryItem, home page, ModeSwitch, inputBox, image rendering) with the backend mocked
